/*  使用方法：依赖文件jquery   引入本文件及ies-select.css
	let ies = new IesChosen({
		id:'#sss',     //id名   <select>标签的id
		data:arr,      //数据为json结构,必须有name,id[{name:76,id:76}].不传默认<option>标签的value,text
		pagelength:10  //每页显示条数，默认5
	})
*/
